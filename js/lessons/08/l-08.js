...
// 
// ECMAScript 5 і JavaScript 1.8.5 це реалізація ECMAScript від Mozilla
// з додатковими функціями. Це розширений варіант специфікації 
// ECMAScript (і її поточних реалізацій в IE, Chrome і Opera). 
// Mozilla просуває нові функції, додаючи їх до власного браузера.
// 
